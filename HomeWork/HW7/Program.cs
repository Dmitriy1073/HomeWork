...
// закоментим пока Console.WriteLine("Введите искомый элемент массива");
...
// пока закоментим FindMedianColuns(array2);
